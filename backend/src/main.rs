...
struct Args {
    ...
    /// "https://aether.int.techboredom.com". Set this whenever the app is
    ...
    /// "proxy.aether.int.techboredom.com" — a deployment named `foo` is then
    /// served at `foo.proxy.aether.int.techboredom.com`, on its own origin
